...
namespace GaoYaXianShu.Sevice
{
    public class PLCService
    {
        ...
        {
            string PHeader = "[流程字反馈：收到物料校验申请失败]";
        ...
        {
            string PHeader = "[流程字反馈：收到数据上传申请失败]";
        ...
        {
            string PHeader = "[设置MES反馈：物料校验异常失败]";
        ...
        {
            string PHeader = "[设置MES反馈：物料校验成功失败]";
        ...
        {
            string PHeader = "[设置MES反馈：数据上传异常失败]";
        ...
        {
            string PHeader = "[设置MES反馈：数据上传成功失败]";
