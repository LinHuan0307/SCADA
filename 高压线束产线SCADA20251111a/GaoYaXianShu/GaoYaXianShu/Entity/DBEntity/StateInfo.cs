...
{
    [System.Serializable(), System.ComponentModel.DataAnnotations.Schema.Table("StateInfo")]
    public class StateInfo : ICloneable
    {
        public StateInfo()
        {
        ...
        /// 这是PLC的第几条状态ID。
        /// </summary>
        [System.ComponentModel.DataAnnotations.Schema.Column("StateId")]
